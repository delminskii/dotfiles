...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/nikolay/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["material.vim"] = {
    loaded = true,
    path = "/home/nikolay/.local/share/nvim/site/pack/packer/start/material.vim",
  ...
  ["vim-startuptime"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/nikolay/.local/share/nvim/site/pack/packer/opt/vim-startuptime",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/nikolay/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
  ...
  vimux = {
    loaded = true,
    path = "/home/nikolay/.local/share/nvim/site/pack/packer/start/vimux",
